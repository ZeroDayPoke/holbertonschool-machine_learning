...
Deep27 = __import__('more_readable_dnn').DeepNeuralNetwork
Deep28 = __import__('more_readable_dnn').DeepNeuralNetwork
...
deep27 = Deep27.load_network('27-output.pkl')
...
deep28 = Deep28.load_network('28-saved.pkl')
