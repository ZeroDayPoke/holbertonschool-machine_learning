...
def projection_block(A_prev, filters, s=2):
    ...
    X = K.layers.Conv2D(F11, (1, 1), strides=s, kernel_initializer='he_normal')(A_prev)
    ...
    A_shortcut = K.layers.Conv2D(F12, (1, 1), strides=s, kernel_initializer='he_normal')(A_prev)
